...
public class IsoGenerator extends IsoObject {
    ...
    public void update() {
        ...
        if (this.isActivated()) {
            ...
            WorldSoundManager.instance.addSoundRepeating(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), radius, 1, false);
    ...
    public void setSurroundingElectricity() {
        ...
        if (this.square != null && this.square.chunk != null) {
            ...
            var4 = this.square.getX() - radius;
            int var20 = this.square.getX() + radius;
            int var6 = this.square.getY() - radius;
            int var7 = this.square.getY() + radius;
            int var8 = Math.max(0, this.getSquare().getZ() - levelDistance);
            int var9 = Math.min(8, this.getSquare().getZ() + levelDistance);

            for(int var10 = var8; var10 < var9; ++var10) {
                for(int var11 = var4; var11 <= var20; ++var11) {
                    for(int var12 = var6; var12 <= var7; ++var12) {
                        if (!(IsoUtils.DistanceToSquared((float)var11 + 0.5F, (float)var12 + 0.5F, (float)this.getSquare().getX() + 0.5F, (float)this.getSquare().getY() + 0.5F) > radius * radius)) {
    ...
    private void updateFridgeFreezerItems() {
        if (this.square != null) {
            int var1 = this.square.getX() - radius;
            int var2 = this.square.getX() + radius;
            int var3 = this.square.getY() - radius;
            int var4 = this.square.getY() + radius;
            int var5 = Math.max(0, this.square.getZ() - levelDistance);
            int var6 = Math.min(8, this.square.getZ() + levelDistance);

            for(int var7 = var5; var7 < var6; ++var7) {
                for(int var8 = var1; var8 <= var2; ++var8) {
                    for(int var9 = var3; var9 <= var4; ++var9) {
                        if (IsoUtils.DistanceToSquared((float)var8, (float)var9, (float)this.square.x, (float)this.square.y) <= radius * radius) {
    ...
    private boolean touchesChunk(IsoChunk var1) {
        ...
        if (var2 == null) {
            ...
            int var5 = var3 + 10 - 1;
            int var6 = var4 + 10 - 1;
            if (var2.x - radius > var5) {
                return false;
            } else if (var2.x + radius < var3) {
                return false;
            } else if (var2.y - radius > var6) {
                return false;
            } else {
                return var2.y + radius >= var4;
            }
        }
    }
        ...
        if (var0 != null) {
            for(int var1 = 0; var1 < AllGenerators.size(); ++var1) {
                ...
                if (var2.getSquare() != null) {
                    ...
                    if (var3 <= var2.radius * var2.radius) {
    ...
    public static boolean isPoweringSquareNew(int var0, int var1, int var2, int var3, int var4, int var5, int radius, int levelDistance) {
        int var6 = Math.max(0, var2 - levelDistance);
        int var7 = Math.min(8, var2 + levelDistance);
        if (var5 >= var6 && var5 < var7) {
            return IsoUtils.DistanceToSquared((float)var0 + 0.5F, (float)var1 + 0.5F, (float)var3 + 0.5F, (float)var4 + 0.5F) <= radius * radius;
        } else {
            return false;
        }
    }
